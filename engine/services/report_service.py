...
from engine.paths import default_artifacts_root as paths_default_artifacts_root
...
class ReportService:
    ...
    ``artifacts_root`` defaults to :func:`engine.paths.default_artifacts_root` when omitted.
    """
