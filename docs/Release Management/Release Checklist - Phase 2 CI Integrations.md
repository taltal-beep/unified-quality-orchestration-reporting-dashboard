...
---
**Context & Links:**
- [[CI-CD Pipeline Setup]], [[QA Strategies#CI and streaming output]], [[Command Reference#Other entry points (not `testo` Typer tree)]], [[Architecture Overview]]
- Previous: [[Release Checklist - Phase 1 Foundation]] · Next: [[Release Checklist - Phase 2 Ghost Mode]]
