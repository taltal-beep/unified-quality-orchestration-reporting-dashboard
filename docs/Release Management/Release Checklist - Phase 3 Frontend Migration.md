...
- [ ] `python3 -m pytest -q --no-cov tests/contract/testo_core/test_ghost_summary_contract.py tests/contract/testo_core/test_ghost_ndjson_contract.py`
...
- [ ] `docs/Release Management/Release Checklist - Phase 3 Frontend Migration.md`
...
---
**Context & Links:**
- [[Streamlit to React Migration Guide]], [[Architecture Overview]], [[Command Reference]]
- Previous: [[Release Checklist - Phase 2 Runner Image]] · Next: [[Release Checklist - Phase 3 Delta Engine]]
